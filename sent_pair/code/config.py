...
def parse_args():
    ...
    parser.add_argument('--data', type=str, default='sick',
                        help='Dataset used for training and testing')

    # model arguments
    parser.add_argument('--model_type', default='fplstm',
                        help='Type of model')
    ...
    parser.add_argument('--tune_embs', action='store_true',
